...
<a href="#"><img alt="derjozelot – Server Nerd" src="https://capsule-render.vercel.app/api?type=waving&color=gradient&height=200&section=header&text=derjozelot&fontAlignY=35&fontSize=50&desc=Server%20Infra%20%7C%20Home%20Lab%20%7C%20Hosting&descSize=14&descAlignY=50&animation=fadeIn" align="center" style="width: 100%"></a>

<div align="center">
  <p>🧠 Tech enthusiast from Germany • 🎧 Sound tech • 🛠️ Home labber</p>
  <p>Running my own hosting stack with Proxmox, Docker and UniFi.</p>
</div>
...
<div align="center">
  <p>• Hosting platform (Docker + Pterodactyl)</p>
  <p>• Discord bots in Java</p>
  <p>• Smart Candy Machine (Raspberry Pi Pico + MicroPython)</p>
</div>
